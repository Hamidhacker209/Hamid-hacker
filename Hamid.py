 ...
 @@@@@@                                 @@@@@@
  ...
  @@@@@           88888888888           @@@@@
    ...
    @@@@        888888888888888        @@@@
     ...
     @@ @@@        Hamid takworo karin        @@@ @@\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mBalochhacker\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд
...
jalan("\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИтФИWhatsApp Num :  +923473057179тФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ")
...
CorrectPassword = "HMDKHAN"loop = 'true'
...
def pilih_super():
	...
	if peak =="":
		...
		pilih_super()print "\033[1;91mTotal IDs\033[1;93m: \033[1;94m"+str(len(id))
...
: \033[1;93m.HAMID PATHAN HACKER.... \033[1;93m :
